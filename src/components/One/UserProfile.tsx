        ...
        <>
            <div className="w-[36rem] gap-x-4 bg-white rounded-lg p-12 flex">
                ...
                <div className='space-y-7'>
                    ...
                    <p className='font-lg'>
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Explicabo ut, alias delectus sint dolore suscipit repellendus at optio. Velit dolores beatae quis non delectus quasi nam excepturi eum illo autem?
                    </p>
                    <button className='rounded-md border-2 border-[#c4cadf]'>Show more</button>
                </div>
            </div>
        </>
    )
